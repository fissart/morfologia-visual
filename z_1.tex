...
\protect\hypertarget{def:www2}{}{\label{def:www2} \iffalse (Geomorfología) \fi{} }La geomorfología es una rama de la geografía1​ y de la geología2​ que tiene como objetivo el estudio de las formas de la superficie terrestre enfocado en describir, entender su génesis y su actual comportamiento.
\end{definition}
...
\begin{definition}[Formas naturales]
\protect\hypertarget{def:ww3}{}{\label{def:ww3} \iffalse (Formas naturales) \fi{} }Son objetos presentes en la naturaleza manisfestandose como elementos que interactuan en nuestro entorno
\end{definition}
Son objetos presentes en la naturaleza manisfestandose como elementos que interactuan en nuestro entorno \[ \int_{1}^{3}w_1 \]

\begin{definition}[Formas naturales]
\protect\hypertarget{def:w3w}{}{\label{def:w3w} \iffalse (Formas naturales) \fi{} }Son objetos presentes en la naturaleza manisfestandose como elementos que interactuan en nuestro entorno www
\end{definition}
