...
\hypertarget{vectores-wwwwwwwwwwwwww}{%
\chapter{Vectores wwwwwwwwwwwwww}\label{vectores-wwwwwwwwwwwwww}}
...
\begin{theorem}[Ecuaciones de la recta tangente de una parábola]
...
\begin{example}
\protect\hypertarget{exm:unnamed-chunk-8}{}{\label{exm:unnamed-chunk-8} }wwwwwwwww
\end{example}
